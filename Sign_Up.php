...
<body>
    <!-- Header -->
    <header>
        <a href="http://localhost/Car_Rentel_Website/index.html" class="logo"><img src="images/jeep.jpg" alt=""></a>
        ...
        <div class="header-btn">
            <a href="http://localhost/Car_Rentel_Website/Sign_Up.php" class="sign-up">Sign Up</a>
            <a href="http://localhost/Car_Rentel_Website/SignIn.php" class="sign-in">Sign In</a>
        </div>
    </header>
    <!--SignUp and SignIn -->
    <div class="form">
...
if(isset($_POST['Sign_Up']))
{
    ...
    try {
        ...
        $mail->Body    = "Dear $name <br> 
                          ...
                          If you have any Query freely mail us on $email";
